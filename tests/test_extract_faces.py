...
def test_different_detectors():
    ...
    for detector in detectors:
        img_objs = Model.extract_faces(img_path=img_path, detector_backend=detector)
...
def test_backends_for_enforced_detection_with_non_facial_inputs():
    ...
    for detector in detectors:
        with pytest.raises(ValueError):
            _ = Model.extract_faces(img_path=black_img, detector_backend=detector)
...
def test_facial_coordinates_are_in_borders():
    ...
    for i, detector_backend in enumerate(detectors):
        results = Model.extract_faces(img_path=img_path, detector_backend=detector_backend)
