...
model: FacialRecognition = Model.build_model(task="facial_recognition", model_name=model_name)
...
img1 = Model.extract_faces(img_path="dataset/img1.jpg")[0]["face"]
img1 = cv2.resize(img1, target_size)
img1 = np.expand_dims(img1, axis=0)  # to (1, 224, 224, 3)
img1_representation = model.forward(img1)

img2 = Model.extract_faces(img_path="dataset/img3.jpg")[0]["face"]
